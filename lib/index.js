...
function insertCompaniesOnPage(page) {
  var pageURI, pageHTML, pageCompanies;
...
function createShopifyCsv() {
  var _shops, shops, shopsCSV, filePath;
  ...
  return regeneratorRuntime.async(function createShopifyCsv$(_context10) {
    while (1) switch (_context10.prev = _context10.next) {
      ...
      case 4:
        ...
        _context10.next = 9;
        return regeneratorRuntime.awrap(_csv2.default.stringifyAsync(shops, { header: true }));

      case 9:
        shopsCSV = _context10.sent;
        filePath = _path2.default.join(__dirname, '..', 'data', 'nyc-shopify-companies.csv');
        _context10.next = 13;
        return regeneratorRuntime.awrap(_fs2.default.writeFileAsync(filePath, shopsCSV));

      case 13:
        return _context10.abrupt('return', shopsCSV);
...
function main() {
  ...
  return regeneratorRuntime.async(function main$(_context11) {
    while (1) switch (_context11.prev = _context11.next) {
      case 0:
        _context11.next = 2;
        return regeneratorRuntime.awrap(numberOfCompanies());

      case 2:
        NOC = _context11.sent;
        NOP = numberOfPages(NOC);
        _context11.next = 6;
        return regeneratorRuntime.awrap(pouchClient.info());
      ...
      case 6:
        ...
        _context11.next = 10;
        return regeneratorRuntime.awrap(scanPages(NOP));

      case 10:
        _context11.next = 12;
        return regeneratorRuntime.awrap(scanProfiles());

      case 12:
        _context11.next = 14;
        return regeneratorRuntime.awrap(scanWebsites());

      case 14:
        _context11.next = 16;
        return regeneratorRuntime.awrap(createCsv());

      case 16:
        _context11.next = 18;
        return regeneratorRuntime.awrap(createShopifyCsv());
